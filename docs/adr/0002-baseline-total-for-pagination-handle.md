...
offset against the same frozen window (absolute `start`/`end` timestamps captured at page-0 time — see
ADR-0001 and the Pagination handle entry in CONTEXT.md). FortiAnalyzer's `total-count` is authoritative
